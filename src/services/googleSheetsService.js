...
// 🔧 Corregido: la pestaña real de la planilla es "Awr - SQLs - Rep" (antes apuntaba a "Hoja 1", inexistente)
const SHEET_NAME_2026 = 'Awr%20-%20SQLs%20-%20Rep'
...
function parse2026(rows) {
  ...
  // Acumulado del año (CPA/CPL acumulado = inversión acumulada / leads o ventas acumuladas)
  let cumInv=0, cumLeads=0, cumVentas=0
  const convSeries = MONTHS_2026.map(m=>{
    const leadsMes  = num(rTLeads?.[m.col])
    const ventasMes = num(rVentas?.[m.col])
    const invMes    = num(rTInv?.[m.col])
    cumInv    += invMes
    cumLeads  += leadsMes
    cumVentas += ventasMes
    return {
      ...
      cpa: num(rCPA?.[m.col]),
      cpl: num(rCPL?.[m.col]),
      cpaCum: cumVentas>0 ? cumInv/cumVentas : 0,
      cplCum: cumLeads>0  ? cumInv/cumLeads  : 0,
    }
  })
  ...
  const igSegFixed = [
    {mes:'Ene/26',valor:14500},{mes:'Feb/26',valor:15000},{mes:'Mar/26',valor:15600},{mes:'Abr/26',valor:16100},
    {mes:'May/26',valor:16700},{mes:'Jun/26',valor:17100},{mes:'Jul/26',valor:17720},{mes:'Ago/26',valor:18367},
  ]
  ...
  const ventasMvd  = [
    {mes:'Ene/26',valor:61075},{mes:'Feb/26',valor:80824},{mes:'Mar/26',valor:82998},{mes:'Abr/26',valor:71837},
    {mes:'May/26',valor:76457},{mes:'Jun/26',valor:121834},{mes:'Jul/26',valor:104250},{mes:'Ago/26',valor:98420},
  ]
  const ventasPdE  = [
    {mes:'Ene/26',valor:60888},{mes:'Feb/26',valor:21679},{mes:'Mar/26',valor:40171},{mes:'Abr/26',valor:51701},
    {mes:'May/26',valor:33973},{mes:'Jun/26',valor:39151},{mes:'Jul/26',valor:58536},{mes:'Ago/26',valor:58685},
  ]
  // Ticket promedio — datos reales del Excel 2026 (Métricas ventas)
  // Ticket B2C+ (R50 = B2C+ ventas USD / B2C+ únicas)
  const ticketB2Bplus = [
    {mes:'Ene/26',valor:8240},{mes:'Feb/26',valor:7454},{mes:'Mar/26',valor:6377},{mes:'Abr/26',valor:11710},
    {mes:'May/26',valor:8548},{mes:'Jun/26',valor:10091},{mes:'Jul/26',valor:8223},{mes:'Ago/26',valor:9621},
  ]
  // Ticket B2C (R33 Mvd ticket avg)
  const ticketB2B     = [
    {mes:'Ene/26',valor:763},{mes:'Feb/26',valor:1555},{mes:'Mar/26',valor:1092},{mes:'Abr/26',valor:1088},
    {mes:'May/26',valor:1195},{mes:'Jun/26',valor:1997},{mes:'Jul/26',valor:1797},{mes:'Ago/26',valor:1640},
  ]
